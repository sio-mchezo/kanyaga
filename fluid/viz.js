...
let lastColorChangeTime = Date.now();
 ...
 // draw spectrum
 // the array here is the EQ [0-255]
 // 0-85=bass, 85-170=mid, 170-255=high
 function drawSplat(array) {
     ...
     //  // if 0-3 are maxxed out, show a splat
    // best yet for bass
     if (array[0]>250 && array[1]>250 && array[2]>250) {        
            config.SPLAT_RADIUS = 6;  
            multipleSplats(1);
     }
...
if (viz) {
    thistime = Math.round(context.currentTime);
